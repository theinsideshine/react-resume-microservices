...
import {Testimonial, TestimonialSection} from '../../data/dataDef';
...
const Testimonials: FC = memo(() => {
  ...
  const [testimonialNombre1, setTestimonialNombre1]= useState('');
  const [testimonialTexto1, setTestimonialTexto1]= useState('');
  const [testimonialNombre2, setTestimonialNombre2]= useState('');
  const [testimonialTexto2, setTestimonialTexto2]= useState('');
    ...
    const ApiCall = async () => {    
     ...
     console.log(body);
      ...
      if(response.status === 200) {  
        ...
        setTestimonialNombre1(body.testimonialNombre1);
        setTestimonialTexto1(body.testimonialTexto1);
        setTestimonialNombre2(body.testimonialNombre2);
        setTestimonialTexto2(body.testimonialTexto2);
  ...
  const testimonial: TestimonialSection = {
    ...
    testimonials: [
      {
        name: testimonialNombre1,
        text: testimonialTexto1,
        image: 'https://cloudflare-ipfs.com/ipfs/Qmd3W5DuhgHirLHGVixi6V76LhCkZUz6pnFt5AJBiyvHye/avatar/169.jpg',
      },
      {
        name: testimonialNombre2,
        text: testimonialTexto2,
  ...
  useInterval(next, 20000); // Tiempo de lectura de los testimoniso
